  ...
  const drawRoad = () => {
    ...
    return (
        <div className='p-6 bg-gray-100 min-h-screen'>
            <h1 className='text-exl font-bold mb-6 text-center'>Road Simulation</h1>

            <div className='flex justify-center gap-4 mb-6'>
                <Button onClick={activate} disabled={isActive}>
                    {isActive ? "실행중" : "시작"}
                </Button>
                <Button onClick={stopAnimation} disabled={!isActive}>정지</Button>
            </div>
            ...
            <div className='flex justify-center'>
                <canvas
                    ...
                    className='border-4 border-gray-800 rounded-lg shadow-lg bg-gray-900'
            </div>
        </div>
    )
};
